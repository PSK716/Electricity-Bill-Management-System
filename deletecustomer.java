...
deletecustomer()
{
    setSize(1000,500);
               ...
               // setLayout(new BorderLayout());
                ...
                setVisible(true);
                setTitle("Remove Customer Connection");
                setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                l10=new JLabel("Remove Customer Connection");
                l10.setFont(new Font("arial",Font.BOLD,30));
                l10.setForeground(Color.BLACK);
                l10.setBackground(Color.BLACK);
                l10.setBounds(320,0,800,80);
                ...
                l2=new JLabel(icon2);
                l2.setBounds(260, 10,60, 60);
                t1=new JTextField();
                t1.setFont(new Font("arial",Font.BOLD,15));
                t1.setForeground(Color.BLACK);
                t1.setBounds(550,110,200,30);
                b1=new JButton("Search");
                b1.setFont(new Font("arial",Font.BOLD,20));
                b1.setBounds(350,180,150,30);
                b2=new JButton("Clear");
                b2.setFont(new Font("arial",Font.BOLD,20));
                b2.setBounds(550,180,150,30);
                b3=new JButton("Delete Employee");
                b3.setFont(new Font("arial",Font.BOLD,20));
                b3.setBounds(400,250,250,30);
        ...
        if(d.getSource()==b3)
                        {
                            String text1 = t1.getText();
                            int a = JOptionPane.showConfirmDialog(null, "Are you sure Customer want to Remove Connection?","Remove Connection",JOptionPane.INFORMATION_MESSAGE);
                ...
                if (a == JOptionPane.YES_OPTION) {
                            try
                        {
                           ...
                           String sql1 = "delete from customer where consumer_no = '"+text1+"'";
                           System.out.println("2");
