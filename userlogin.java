...
//                setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                ...
                Icon icon=new ImageIcon("D:\\prologos\\userlogo.png");
               b3=new JButton(icon);
...
//                           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","pratik");
                           ...
                           String sql="select id,password from user1 where id=? and password=?";
                           ...
                           else
        {
            ...
            JOptionPane.showMessageDialog(null, "Login Failed!","Failed",JOptionPane.ERROR_MESSAGE);
             ...
             if(es.getSource()==b2)
             {
             userforgot userfor=new userforgot();
             userfor.setVisible(true);
              userfor.setLocationRelativeTo(null);
